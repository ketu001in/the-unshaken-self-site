...
const DEFAULT_ABOUT_AUTHOR_CONTENT: AboutAuthorContent = {
  ...
  timeline: [
    ...
    { year: "2024", title: "Researching about the book", desc: "Dedicated the year to deep scriptural research, connecting the Gita's teachings with modern psychological insight, and structuring the core chapters." },
  ...
  speaking_topics: [
    ...
    { title: "Ancient Mindfulness vs. Modern App-based Meditation", desc: "Moving beyond passive breathing exercises to active, cognitive meditation systems outlined in the Gita's teachings." }
  ]
};
